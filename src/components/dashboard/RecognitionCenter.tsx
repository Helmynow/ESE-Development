...
export function RecognitionCenter({ user }: RecognitionCenterProps) {
  const [nominations] = useKV<Nomination[]>('nominations', mockNominations)
  ...
  const handleSubmitNomination = async () => {
    ...
    toast.success(`Nomination submitted for ${nominationForm.nomineeName}`)
                      ...
                      <div className="flex-1">
                        ...
                        {nomination.status === 'voting' && (
                          <div>
                            ...
                            <Progress value={(nomination.votes / nomination.totalVoters) * 100} className="h-2" />
                          </div>
                        )}
                      </div>
